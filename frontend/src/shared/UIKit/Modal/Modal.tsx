...
export function Modal({ isOpen, onClose, children }: ModalProps) {
    return isOpen
        ? createPortal(
              <div className={"fixed bottom-0 top-0 left-0 right-0 bg-gray-600/25"}>
                  <div
                      className={
                          "fixed flex h-[calc(100%-1rem)] max-h-full w-full items-center justify-center overflow-y-auto overflow-x-hidden p-4 md:inset-0"
                      }
                  >
