        ...
        <label className={classNames('flex h-5 cursor-pointer items-center gap-1 text-sm font-light', classNameLabel)}>
            <div className="relative h-full">
                <input
                    ...
                    ref={ref}
                />
                <div className="pointer-events-none absolute left-2/4 top-2/4 -translate-x-2/4 -translate-y-2/4 text-white opacity-0 transition-opacity peer-checked:opacity-100 peer-disabled:text-gray-300">
                    <FiCheck />
                </div>
            </div>
            {label}
