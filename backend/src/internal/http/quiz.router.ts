...
export class QuizRouter {
    ...
    public router(): Router {
        ...
        r.put("/api/v1/user/:id_owner/quiz/:id_quiz", this.updateQuiz.bind(this))
        r.delete("/api/v1/user/:id_owner/quiz/:id_quiz", this.deleteQuiz.bind(this))
    ...
    possibleFilter: (keyof getQuizzesFilter)[] = ["name", "title", "description"]
    possibleOrder: (keyof getQuizzesOrder)[] = ["date_create", "name", "title", "description", "ttl"]
    ...
    private async updateQuiz(req: Request, resp: Response) {
        try {
            ...
            await this.quizService.updateQuiz(new updateQuizDTO(
                id_quiz,
                id_owner,
                set
            ))
