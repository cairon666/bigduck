...
export function UserNav({ fullName, avatarURl, email }: UserNavProps) {
    return (
        <Link
            to="/panel/user"
            className="flex items-center justify-between gap-2 rounded-lg border border-transparent bg-gray-20 p-2 duration-75 ease-linear hover:border-yellow-600 focus-visible:border-yellow-500 focus-visible:outline-none"
        >
